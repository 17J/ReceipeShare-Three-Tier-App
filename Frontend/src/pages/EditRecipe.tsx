...
const EditRecipe = () => {
  ...
  useEffect(() => {
    ...
    const fetchRecipe = async () => {
      try {
        ...
        setRecipe({
          ...
          ingredients: recipeData.ingredients.length ? recipeData.ingredients : [""],
          instructions: recipeData.instructions.length ? recipeData.instructions : [""],
          cookingTime: recipeData.cookingTime ? recipeData.cookingTime.toString() : "",
        ...
        toast({
          title: "Error",
          description: (err as Error).message || "Failed to load recipe",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
    ...
    fetchRecipe();
  }, [id, isAuthenticated, navigate, user, toast]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError((err as Error).message || "Failed to update recipe");
      toast({
        title: "Error",
        description: (err as Error).message || "Failed to update recipe",
        variant: "destructive",
      });
    } finally {
      ...
      <div className="flex-grow py-8">
        <div className="recipe-container">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl font-bold text-recipe-dark mb-6">Edit Recipe</h1>
